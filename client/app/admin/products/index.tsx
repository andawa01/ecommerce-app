    ...
    const fetchProducts = async () => {
        try {
            ...
            Toast.show({
                ...
                text2: error.response?.data?.message || error.message || "An error occurred while fetching products."
            });
        } finally {
            setLoading(false);
            setRefreshing(false);
    ...
    const performDelete = async (id: string) => {
        try {
            ...
            Toast.show({
                ...
                text2: error.response?.data?.message || error.message || "An error occurred while deleting the product."
            });
        }
    };
