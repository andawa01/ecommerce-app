    ...
    const fetchAddress = async () => {
        try {
            ...
            Toast.show({
                type: 'error',
                text1: 'Error',
                text2: 'Failed to load checkout information. Please try again.'
            })
        } finally {
    ...
    const handlePlaceOrder = async () => {
        ...
        if (paymentMethod === 'stripe') {
            return Toast.show({
                type: 'error',
                text1: 'Info',
                text2: 'Stripe payment method not implemented yet'
            })
        }
    ...
    <SafeAreaView className='flex-1 bg-surface' edges={["top"]}>
        ...
        <ScrollView className='flex-1 px-4 mt-4'>
            ...
            {selectedAddress ? (
                ...
                <TouchableOpacity 
                onPress={() => router.push('/addresses')} className='bg-white p-6 rounded-xl mb-6 items-center justify-center border-dashed border-2 border-gray-100'>
